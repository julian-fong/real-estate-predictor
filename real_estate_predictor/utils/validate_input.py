...
from real_estate_predictor.utils.extract_dataset import extract_raw_data_listings, subtract_months
...
def transform_neighborhood_input(data):
    ...
    soldPrice_mth_stats = n_data['statistics']['soldPrice']['mth'] #gives avg, count and med
    listPrice_mth_stats = n_data['statistics']['listPrice']['mth'] #gives avg, count and med
    available_mth_stats = n_data['statistics']['available']['mth'] #gives count 
    daysOnMarket_mth_stats = n_data['statistics']['daysOnMarket']['mth'] #gives avg, count and med
    ...
    if end_date_ym in daysOnMarket_mth_stats:
        ...
        mapping["count_daysOnMarket_current"] = daysOnMarket_mth_stats[end_date_ym]['count']
    ...
    if month_1_key in soldPrice_mth_stats:
        ...
        mapping["count_soldPrice_currentL1M"] = soldPrice_mth_stats[month_1_key]['count']
    ...
    if month_1_key in listPrice_mth_stats:
        ...
        mapping["count_listPrice_currentL1M"] = listPrice_mth_stats[month_1_key]['count']
    ...
    if month_1_key in daysOnMarket_mth_stats:
        mapping["avg_daysOnMarket_currentL1M"] = daysOnMarket_mth_stats[month_1_key]['avg']
        mapping["count_daysOnMarket_currentL1M"] = daysOnMarket_mth_stats[month_1_key]['count']
        mapping["med_daysOnMarket_currentL1M"] = daysOnMarket_mth_stats[month_1_key]['med']

    if month_3_key in soldPrice_mth_stats:
        mapping["avg_soldPrice_currentL3M"] = soldPrice_mth_stats[month_3_key]['avg']
        mapping["count_soldPrice_currentL3M"] = soldPrice_mth_stats[month_3_key]['count']
    ...
    if month_3_key in listPrice_mth_stats:
        ...
        mapping["count_listPrice_currentL3M"] = listPrice_mth_stats[month_3_key]['count']
    ...
    if month_3_key in daysOnMarket_mth_stats:
        mapping["avg_daysOnMarket_currentL3M"] = daysOnMarket_mth_stats[month_3_key]['avg']
        mapping["count_daysOnMarket_currentL3M"] = daysOnMarket_mth_stats[month_3_key]['count']
        mapping["med_daysOnMarket_currentL3M"] = daysOnMarket_mth_stats[month_3_key]['med']
        
    if month_6_key in soldPrice_mth_stats:
        mapping["avg_soldPrice_currentL6M"] = soldPrice_mth_stats[month_6_key]['avg']
        mapping["count_soldPrice_currentL6M"] = soldPrice_mth_stats[month_6_key]['count']
    ...
    if month_6_key in listPrice_mth_stats:
        ...
        mapping["count_listPrice_currentL6M"] = listPrice_mth_stats[month_6_key]['count']
    ...
    if month_6_key in daysOnMarket_mth_stats:
        mapping["avg_daysOnMarket_currentL6M"] = daysOnMarket_mth_stats[month_6_key]['avg']
        mapping["count_daysOnMarket_currentL6M"] = daysOnMarket_mth_stats[month_6_key]['count']
        mapping["med_daysOnMarket_currentL6M"] = daysOnMarket_mth_stats[month_6_key]['med']
