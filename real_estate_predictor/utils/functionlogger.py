...
class FunctionLogger:
    ...
    def log_function_call(func):
        ...
        def wrapper(instance, *args, **kwargs):
            defer = kwargs.pop(
                "defer", False
            )  # Default to False if defer is not provided
            log_entry = {
    ...
    def execute_pending_calls(self, clear_pending_calls=False):
        ...
        for log_entry in self.pending_calls:
            ...
            print(
                f"Executing pending function: {func_name} with args={args} kwargs={kwargs}"
            )
    ...
    def execute_logged_calls(self):
        ...
        for log_entry in self.function_logs:
            ...
            kwargs = log_entry["kwargs"]
            print(
                f"Executing logged function: {func_name} with args={args} kwargs={kwargs}"
            )
